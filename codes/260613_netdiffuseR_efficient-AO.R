# =============================================================================
# 260613_netdiffuseR_efficient-AO.R
# Efficient variant of Yuchan's 260613_netdiffuseR_past6mo_revised16.R.
# ONLY the data-loading block is changed (see "EFFICIENT data loading" below);
# every model and output is byte-for-byte identical to revised16 (verified: all
# result CSVs match exactly).
#
